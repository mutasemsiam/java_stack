...
import com.siam.authentication.services.BookService;
...
public class MainController {
    ...
    public String createNewBook(@Valid @ModelAttribute("newBook") Book book, BindingResult result) {
    	if (result.hasErrors()) {
            return "add_book.jsp";
        } else {
    ...
    public String showBook(@PathVariable("bookId") Long bId, Model model, HttpSession session) {
    	if(session.getAttribute("userId") == null) {
			return "redirect:/";
    	}
